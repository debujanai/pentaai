...
const Features = () => (
  <section id="agents" className="bg-black pb-10 md:pb-52">
    <div className="container mx-auto px-3 md:px-10">
      <div className="px-5 py-32">
        ...
        <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
          Experience a suite of intelligent agents designed to revolutionize your blockchain journey, 
          from smart investments to secure development and NFT creation.
        </p>
      </div>
